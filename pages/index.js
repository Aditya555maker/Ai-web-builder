...
export default function Home() {
  ...
  async function generate() {
    ...
    try {
      ...
      catch(e) { throw new Error("Server error: " + text.slice(0, 100)); }
  ...
  if (screen === "loading") return (
    <div style={{minHeight:"100vh",background:"#08080f",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column"}}>
      ...
      <p style={{color:"#555",marginTop:"10px",fontFamily:"monospace"}}>Thoda wait karo...</p>
    </div>
  );

  if (screen === "error") return (
    <div style={{minHeight:"100vh",background:"#08080f",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",padding:"20px"}}>
      <div style={{fontSize:"52px",marginBottom:"16px"}}>⚠️</div>
      <h2 style={{marginBottom:"12px"}}>Error aa gayi</h2>
      <p style={{color:"#f87171",marginBottom:"24px",padding:"12px",background:"rgba(239,68,68,0.1)",borderRadius:"8px",maxWidth:"400px",textAlign:"center",fontFamily:"monospace",fontSize:"13px"}}>{error}</p>
